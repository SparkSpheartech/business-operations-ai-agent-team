...
async def main():
    ...
    await session_service.create_session(
        app_name="brand_search_optimization", user_id="test_user", session_id="test_session"
    )
    runner = Runner(
        agent=root_agent, app_name="brand_search_optimization", session_service=session_service
    )
