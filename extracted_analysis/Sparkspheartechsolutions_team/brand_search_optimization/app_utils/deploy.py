...
@click.option(
    "--display-name",
    default="brand-search-optimization",
    help="Display name for the agent engine",
)
@click.option(
    "--description",
    default="Brand Search Optimization ADK Agent Designed to enhance product titles for retail brand search. It retrieves top keywords, performs searches, and analyzes top results to provide suggestions for enriching product titles",
    help="Description of the agent",
)
@click.option(
    "--source-packages",
    multiple=True,
    default=["./brand_search_optimization"],
    help="Source packages to deploy. Can be specified multiple times (e.g., --source-packages=./app --source-packages=./lib)",
)
@click.option(
    "--entrypoint-module",
    default="brand_search_optimization.agent_engine_app",
...
@click.option(
    "--requirements-file",
    default="brand_search_optimization/app_utils/.requirements.txt",
...
def deploy_agent_engine_app(
    ...
    labels_dict["vertex-agent-sample-id"] = "brand-search-optimization"
